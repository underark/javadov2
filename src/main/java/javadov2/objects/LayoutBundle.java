...
public class LayoutBundle {
    ...
    public LayoutBundle(Node panel, Map<TypeOfButton, ButtonBase> buttons, Map<InputFieldType, TextInputControl> inputs, GridPane display, Map<ComboBoxType, ComboBoxBase> comboBoxes) {
        this.panel = panel;
